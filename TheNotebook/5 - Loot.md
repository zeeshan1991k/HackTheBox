# Loot
## tar archive of home folder of user Noah found in /var/backups 
Tar archive of home folder of user Noah contained private ssh key to ssh-login as user Noah.
```bash
