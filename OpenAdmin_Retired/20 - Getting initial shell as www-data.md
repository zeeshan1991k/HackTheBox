# Getting initial shell as www-data
OpenNetAdmin version 18.1.1 has exploit on [github](https://github.com/amriunix/ona-rce)
...
```
Getting initial shell as www-data using this exploit.
![[Pasted image 20210706024339.png]]
