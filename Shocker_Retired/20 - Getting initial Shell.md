...
Using [`Shellshock apache mod_cgi remote exploit` ](https://www.exploit-db.com/exploits/34900).
* Modified line 93 to include /cgi-bin/user.sh file.
...
try:
	...
	pages = ["/cgi-sys/entropysearch.cgi","/cgi-sys/defaultwebpage.cgi","/cgi-mod/index.cgi","/cgi-bin/user.sh","/cgi-bin-sdb/printenv"]
